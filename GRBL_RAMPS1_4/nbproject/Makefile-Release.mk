...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/grbl_ramps1_4: ${OBJECTFILES}
	...
	${LINK.c} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/grbl_ramps1_4 ${OBJECTFILES} ${LDLIBSOPTIONS}

${OBJECTDIR}/coolant_control.o: coolant_control.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/coolant_control.o coolant_control.c

${OBJECTDIR}/eeprom.o: eeprom.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/eeprom.o eeprom.c

${OBJECTDIR}/gcode.o: gcode.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/gcode.o gcode.c

${OBJECTDIR}/limits.o: limits.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/limits.o limits.c
...
${OBJECTDIR}/motion_control.o: motion_control.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/motion_control.o motion_control.c

${OBJECTDIR}/nuts_bolts.o: nuts_bolts.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/nuts_bolts.o nuts_bolts.c

${OBJECTDIR}/planner.o: planner.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/planner.o planner.c
...
${OBJECTDIR}/probe.o: probe.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/probe.o probe.c

${OBJECTDIR}/protocol.o: protocol.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/protocol.o protocol.c
...
${OBJECTDIR}/spindle_control.o: spindle_control.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/spindle_control.o spindle_control.c

${OBJECTDIR}/stepper.o: stepper.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/stepper.o stepper.c
